    ...
    <main>
      ...
      <?php
        get_template_part('cta-section', null, [
          ...
          'title' => 'Orchestrate onboarding, research, and GTM in one flow',
          'description' => 'Join TRYGO to capture customer insight, validate hypotheses, and package your product with AI co-pilot support.',
          'button_text' => 'Start with Freemium',
          'button_url' => 'https://dashboard.trygo.io/dashboard',
          'image_url' => home_url() . '/wp-content/uploads/2025/09/glowing-spider-web-dark-abstract-backdrop-generated-by-ai.jpg',
          'image_alt' => 'Team collaborating on launch collateral',
          'section_id' => 'features-cta',
          'title_id' => 'features-cta-title'
        ]);
      ?>
    </main>
