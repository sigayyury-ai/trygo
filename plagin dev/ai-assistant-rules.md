...
- Все файлы разработки хранятся в папке `plagin dev`
...
### Процесс работы
1. **Уточнить** - задать все необходимые вопросы
...
- **Безопасность**: SSH-ключи, валидация данных, защита от SQL-инъекций

### Структура проекта
- Папка разработки: `plagin dev`
- Каждый плагин в отдельной подпапке
- Согласование прототипа перед разработкой
- Тестирование перед загрузкой на хостинг
